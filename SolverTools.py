...
class IterationSolution:
    ...
    def __init__(self,
        ...
        self.converged = precision < tolerance
        ...
        self.dCn = dCn
        self.dCq = dCq
        self.axialForceCoefficient = dCt
        self.azimuthalForceCoefficient = dCn
...
class Result:
    ...
    def __init__(self, radius, dT, dQ, cP, totalThrust, totalTorque, annulusWidth=None):
